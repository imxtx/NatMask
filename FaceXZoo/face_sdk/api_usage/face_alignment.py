...
if __name__ == "__main__":
    ...
    # read image
    image_folder = "api_usage/face_256/"

    for img_id in range(31, 32):
        image_path = image_folder + f"/images/{img_id:03}.jpg"
        image_det_txt_path = image_folder + f"/detected/{img_id:03}_detect_res.txt"
        ...
        try:
            for i, line in enumerate(lines):
                ...
                save_path_img = image_folder + f"/lms/{img_id:03}_landmark_res.jpg"
                save_path_txt = image_folder + f"/lms/{img_id:03}_landmark_res.txt"
