...
def norm_crop(img, landmark, image_size=224, mode="arcface", border_size=5):
    """Crop face with additional border
    ...
    Args:
        ...
        border_size: Border size in pixels to add on each side
    """
    # Expand landmarks outward by border_size pixels
    landmark = landmark.copy()
    # Move eyes left/right
    landmark[0][0] -= border_size  # left eye x
    landmark[1][0] += border_size  # right eye x
    # Move mouth corners left/right
    landmark[3][0] -= border_size  # left mouth x
    landmark[4][0] += border_size  # right mouth x
    # Move top landmarks up and bottom landmarks down
    landmark[[0, 1], 1] -= border_size  # eyes y
    landmark[[3, 4], 1] += border_size  # mouth y
