# based on: https://github.com/Xiaoccer/MobileFaceNet_Pytorch
...
def mobileface(device="cpu"):

    logging.info("Loading pre-trained MobileFace model ...")
    import pathlib

    root_dir = pathlib.Path(__file__).parent.parent.resolve()
    model = MobileFacenet()
    state_dict = torch.load(
        f"{str(root_dir)}/pretrained_models/mobileface.pth", map_location=device
    )
